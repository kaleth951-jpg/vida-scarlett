/* ============================================================
  CHATBOT "PREGÚNTALE A SCARLETT"
   Bot basado en reglas (sin servidor): detecta palabras clave
  y responde sobre la vida, las películas, entrevistas y legado
  de Scarlett Johansson. Incluye chips de sugerencias y efecto
   de "escribiendo…".
   ============================================================ */
...
(function chatbot() {
  ...
  const SCARLETT_KB = [
    {
      keys: ["quien fue", "vida", "biografia", "nacio", "scarlett", "johansson"],
      reply: "<strong>Scarlett Johansson</strong> nació en Nueva York en 1984. Comenzó a actuar de niña y construyó una carrera que cruza el drama, la comedia, la acción y la producción."
    },
    {
      keys: ["peliculas", "obras", "filmografia", "films", "peliculas principales"],
      reply: "Sus películas más conocidas incluyen <strong>Lost in Translation</strong> (2003), <strong>La joven de la perla</strong> (2003), <strong>Her</strong> (2013), <strong>Historia de un matrimonio</strong> (2019) y <strong>Black Widow</strong> (2021). Mira la sección <a href=\"#obras\">Películas</a>."
    },
    {
      keys: ["black widow", "natasha", "marvel", "vengadores", "avengers"],
      reply: "Interpretó a <strong>Natasha Romanoff / Black Widow</strong> durante una década en el universo Marvel. El personaje tuvo su propia película en 2021, con Scarlett también como productora ejecutiva."
    },
    {
      keys: ["oscar", "nominacion", "premios", "premio"],
      reply: "Recibió dos nominaciones al Óscar en 2020: Mejor actriz por <strong>Historia de un matrimonio</strong> y Mejor actriz de reparto por <strong>Jojo Rabbit</strong>."
    },
    {
      keys: ["imagenes", "fotos", "fotografias", "galeria"],
      reply: "Encontrarás enlaces a galerías de <a href=\"#centro-gabo\">Wikimedia Commons, Flickr, Getty Images e IMDb</a> en la sección Legado."
    },
    {
      keys: ["juego", "jugar", "memoria"],
      reply: "En <a href=\"#juego\">Memoria de Scarlett</a> puedes encontrar parejas de películas, años y pistas."
    },
    {
      keys: ["hola", "buenas", "hey", "saludos"],
      reply: "¡Hola! Puedo contarte sobre la <strong>vida</strong> de Scarlett, sus <strong>películas</strong>, Black Widow, premios o galerías de imágenes."
    }
  ];
  ...
  const FALLBACK =
    "No tengo ese dato en mi archivo de cine. Prueba preguntarme por: " +
    "<em>sus películas</em>, <em>Black Widow</em>, <em>su vida</em>, " +
    "<em>sus nominaciones al Óscar</em> o <em>galerías de imágenes</em>.";
  ...
  function openChat() {
    ...
    if (!greeted) {
      ...
      setTimeout(() => {
        addMessage(
          "¡Hola! Pregúntame por la <strong>vida</strong> de Scarlett, sus <strong>películas</strong>, " +
          "Black Widow, sus premios o las <strong>galerías de imágenes</strong>. " +
