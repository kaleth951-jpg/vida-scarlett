/* ============================================================
  JUEGO: MEMORIA DE SCARLETT
  Juego de parejas sobre las películas de Scarlett Johansson.
  Cada película tiene dos cartas: el TÍTULO y su AÑO + PISTA.
...
(function memoryGame() {
  ...
  /* ---------- Datos: 6 películas = 12 cartas ---------- */
  const OBRAS = [
    { id: "translation", titulo: "Lost in Translation",       pista: "2003 · Cine independiente" },
    { id: "perla",       titulo: "La joven de la perla",      pista: "2003 · Drama de época" },
    { id: "iron",        titulo: "Iron Man 2",                pista: "2010 · Primera Black Widow" },
    { id: "her",         titulo: "Her",                       pista: "2013 · La voz de Samantha" },
    { id: "marriage",    titulo: "Historia de un matrimonio", pista: "2019 · Nominación al Óscar" },
    { id: "widow",       titulo: "Black Widow",               pista: "2021 · Protagonista y productora" }
  ];
